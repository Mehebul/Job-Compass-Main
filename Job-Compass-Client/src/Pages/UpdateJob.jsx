      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="create-job-flex">
            ...
            <div className="lg:w-1/2 w-full">
                ...
                <input type="text" placeholder="Ex: Kolkata" defaultValue={jobLocation}
        ...
        <div className="create-job-flex">
            <div className="lg:w-1/2 w-full">
                ...
                <input type="url" defaultValue={companyLogo} placeholder="Paste your company logo URL: https://weshare.com/img" 
