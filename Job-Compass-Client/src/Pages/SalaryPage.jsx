    ...
    <div className = 'max-w-screen-2x1 container mx-auto x1:px-24 px-4'>
      ...
      <div className='mt-5'>
        <div className="search-box p-2 text-center mb-2">
            <input type="text" id="search" className='py-2 pl-3 border focus:outline-none lg:w-/12 mb-4 w-full'onChange={(e) => setSearchText(e.target.value)}/>
            ...
            salary.map((data) => (
              <div key={data.id} className='shadow px-4 py-8' >
                ...
                <div className='flex flex-wrap gap-4'>
                  <a herf="/" className='underline'>{data.status}</a>
                  <a herf="/" className='underline'>{data.skills}</a>
                </div>
