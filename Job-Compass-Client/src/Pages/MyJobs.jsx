...
const MyJobs = () => {
  const email = "123saptarsi@gmail.com"
  ...
  useEffect(() =>{
    setIsLoading(true)
    fetch("http://localhost:3000/myJobs/123saptarsi@gmail.com")
    .then(res => res.json())
    .then(data => {
      setJobs(data);
      setIsLoading(false)
  ...
  return <div className="max-w-screen-2xl container mx-auto x1:px-24 px-4">
    <div className="my-jobs-container">
      <h1 className='text-3xl text-blue font-bold mb-1 text-center'>ALL MY JOBS</h1>
