...
const Banner = ({query, handleInputChange}) => {
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
        <h1 className='text-5xl font-bold text-primary mb-3'>Find Your <span  className='text-blue'>Preferable Job</span> Today</h1>
        <p className='text-lg text-black/70 mb-8'>Thousands of jobs are waiting for you in engineering, IT sectors and more...</p>
        ...
        <form>
            ...
            <div className='flex md: rounded-s-md rounded shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full'>
                ...
                <button type='submit' className='bg-blue py-2 px-8 text-white md:rounded-s-none rounded'>Hunt</button>
            </div>
        </form>
    </div>
  )
